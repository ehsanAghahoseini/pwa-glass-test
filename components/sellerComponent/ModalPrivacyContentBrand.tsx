...
const ModalPrivacyContentBrand = () => {
        ...
        <div className="p-4 w-full flex flex-col">
            ...
            <div className=' flex flex-col py-6 '>
                ...
                <p className='text-justify mt-2'>
                    This website is operated by Optic4Less. Throughout the site, the terms “we”, “us” and “our” refer
                    to Optic4Less. Optic4Less offers this website, including all information, tools, and services
                ...
                <p className='text-justify mt-2'>
                    The virtual try on tool will capture images of your face, it is able to render a 180-degree view of
                    yourself with your chosen frames from Optic4Less App. By using the Virtual Try-On tool, you
                    expressly consent to the Terms of Use and our Privacy Policy.
                </p>
                ...
                <p className='text-justify mt-2'>
                    ...
                    or cancel an order, we may attempt to notify you by contacting the e-mail and/or billing address/
                    phone number provided at the time the order was made. We reserve the right to limit or prohibit
                ...
                <p className='text-justify mt-2'>
                    In no case shall Optic4Less, our directors, officers, employees, affiliates, agents, contractors,
                    ...
                    limitation lost profits, lost revenue, lost savings, loss of data, replacement costs, or any similar damages, whether based in contract, tort (including negligence), strict liability or otherwise,
                ...
                <p className='text-justify mt-2'>
                    You agree to indemnify, defend and hold harmless Optic4Less and our parent, subsidiaries,
                ...
                <p className='text-justify mt-2'>
                    ...
                    governed by and construed in accordance with the laws of the United Arab Emirates.
                </p>
                ...
                <p className='text-justify mt-2'>
                    You shall use all reasonable endeavors to procure that your staff shall, keep confidential all
                    Confidential Information received from Optic4Less. In doing so, you shall use at least the same
                    degree of care it uses to keep Optic4Less information confidential, but in no event less than a
                    reasonable degree of care .
                </p>

                <p className='text-justify mt-2'>
                    In consideration of your intention to utilise and receive information pertaining to the Optic4Less
                    platform you agree to undertake, respect and preserve the confidentiality of this information and of
                    all other information and explanations provided by Optic4Less. Accordingly, you shall not, without
                    prior written consent, either:
                </p>

                <p className='text-justify mt-2'>
                    7.1 communicate or otherwise make available the Information to any third party
                    (other than those of our employees who are bound by conditions of secrecy no less
                    strict than those set out in this letter, which we shall enforce at your request); or
                    7.2 use the Information for any purpose other than for determining whether or not
                    to take a license under the Application.
                    7.3 Create similar platforms providing similar services for a period of 10 years
                    from the date of agreeing to these terms of use
                </p>
...
export default ModalPrivacyContentBrand;